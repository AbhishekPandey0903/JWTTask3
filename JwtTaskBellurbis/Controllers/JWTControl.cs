...
using ITokenService = JwtTaskBellurbis.Repository.ITokenService;

namespace JwtTaskBellurbis.Controllers
{
    public class JWTControl : Controller
    {
        ...
        public JWTControl(IConfiguration config, ITokenService tokenService, IUserRepository userRepository)
        {
            _config = config;
        ...
        private UserData GetUser(UserLog userModel)
        {
